...
data=loadmat("D:/specialreport/AI-/sample file/training/tr03-0005/tr03-0005.mat")
data.keys()
data["val"].shape
for channel in range(data["val"].shape[0]):
    file_ID="tr03-0005"
    records=loadmat(f"D:/specialreport/AI-/sample file/training/{file_ID}/{file_ID}.mat")
    records.keys()
    records["val"].shape
...
path="D:/specialreport/AI-/sample file/training/tr03-0005/tr03-0005-arousal.mat"
...
#@@ -29,11 +53,15 @@
#load .hea file
Records=wfdb.rdrecord("D:/specialreport/AI-/sample file/training/tr03-0005/tr03-0005",physical=False)
